...
public:
  void setMutableVariables(std::string className, std::string variableName,
			   std::string message);

private:
  void classWithMutableVariable(const MatchFinder::MatchResult &Result);
  A mutableVariables;
  void hasMutableVariable();
