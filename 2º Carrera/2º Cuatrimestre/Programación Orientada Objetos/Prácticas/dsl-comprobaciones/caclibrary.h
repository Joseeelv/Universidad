...
---vector<bool> exist: vector of boolean indicating the existence of the member variables.
...
- Example:
	...
	memberVariable("A", {"a", "b"}, {"noconst", "const"}, {true}); 	Pass
	memberVariable("A", {"a", "b"}, {"?", "?"}, {true, true});	Pass
	memberVariable("A", {"c"}, {"?"}, {true}); 			Fail
	memberVariable("A", {"c"}, {"?"}, {false}); 			Pass
	memberVariable("A", {"a"}, {"const"}, {true});			Fail
*/
  void memberVariable(string className, vector<string> memberNames,
		      vector<string> constant = {"?"}, vector<bool> exist = {true},
...
/*
- Method: void mutableVariable(string className, vector<string> variableNames, 
            string message)

- Utility: Method to verify the existence of a mutable variable in a class.

- Parameters:
---string className (*): string with the name of the class to be searched.
---vector<string> variableNames (*): vector of strings with the names of the 
      mutable variables to be searched.
- Example:
	...
	mutableVariable("A", {"a"});      	Pass
	mutableVariable("A", {"a", "b"});       Fail
*/
  void mutableVariable(string className, vector<string> variableNames,
		      string message = "MUTABLE VARIABLE NOT FOUND.");
...
---vector<bool> exist: vector of boolean indicating the existence of the methods.
...
- Example:
	...
	method({"method1", "method2"}, {{"Type1", "Type2"}, {}}, "A", {"?", "?"}, {true, true}); Pass
	method({"method3"}, {{"?"}}, "A", {true});                                         	 Fail
	method({"method3"}, {{"?"}}, "A", {false});                                         	 Pass

*/
  void method(vector<string> methodNames, vector<vector<string>> parameters,
	      string className, vector<string> constant = {"?"}, vector<bool> exist = {true}, 
...
*/
  void copyAssignmentOperator(string className, bool exist = true,
			      string message =
